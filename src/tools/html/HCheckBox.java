 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class HCheckBox extends JCheckBox implements HComponent {
	/**
	 * @param value
	 */
	public HCheckBox(String value) {
		super(value);
	}
	...
	public void setSelected(boolean onOff) { super.setSelected(onOff);}
