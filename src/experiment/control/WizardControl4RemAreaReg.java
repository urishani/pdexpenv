 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class WizardControl4RemAreaReg extends AbstractWizardControl {
	 ...
	 * @param pTable
	 */
	public WizardControl4RemAreaReg(MyProperties pProperties, View pView, Table pTable) {
	...
	int tableRows;
	int tableCols;
	int rowStart, rowEnd, colStart, colEnd, divideBy, markWith;
