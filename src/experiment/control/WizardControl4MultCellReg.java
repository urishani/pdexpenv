 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class WizardControl4MultCellReg extends AbstractWizardControl {
	 ...
	 * @param pTable
	 */
	public WizardControl4MultCellReg(MyProperties pProperties, View pView, Table pTable) {
	...
	int tableRows;
	int tableCols;
	int rowIndex, colIndex, multiplyBy;
